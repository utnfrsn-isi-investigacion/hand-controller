...
class TestCarHandler(unittest.TestCase):
    ...
    def test_left_hand_accelerate(self):
        ...
        self.mock_esp32.send_action.assert_any_call(CarHandler.Action.ACCELERATE.value)
    ...
    def test_right_hand_direction_left(self):
        ...
        self.mock_esp32.send_action.assert_any_call(CarHandler.Action.STOP.value)
        self.mock_esp32.send_action.assert_any_call(CarHandler.Action.DIRECTION_LEFT.value)
